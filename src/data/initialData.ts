...
export const INITIAL_BOOKINGS: BookingSubmission[] = [
  {
    ...
    totalPrice: 152303,
    currency: 'JMD',
    budget: '$1,000 USD / person ($152,303 JMD Package Total)',
  ...
  },
  {
    ...
    totalPrice: 358285,
    currency: 'JMD',
    budget: '$2,350 USD / person (approx. $358,285 JMD)',
  ...
  },
  {
    ...
    customerName: 'Zachary Buchanan',
    email: 'zacpremacc12@gmail.com',
    phone: '(876) 848-9772',
    countryOrParish: 'Kingston, Jamaica',
    adultsCount: 1,
    childrenCount: 0,
    preferredTravelDate: 'October 13–18, 2026',
    travelInterestType: 'ready_to_book',
    specialRequests: 'Single room supplement requested. Interested in San Blas day tour.',
    preferredContactMethod: 'whatsapp',
    status: 'Deposit Received',
    depositPaid: 83353,
    totalPrice: 152303,
    currency: 'JMD',
    budget: '$1,000 USD / person ($152,303 JMD Package Total)',
    internalNotes: ['Deposit received via Lynk Jamaica. Spot secured.'],
    createdAt: '2026-09-06T04:45:00Z',
  ...
  },
  {
    ...
    customerName: 'Kadeen Brown',
    email: 'kadeen.brown@example.com',
    phone: '(876) 555-8910',
    countryOrParish: 'Montego Bay, Jamaica',
    adultsCount: 2,
    childrenCount: 0,
    preferredTravelDate: 'November 2026',
    travelInterestType: 'ready_to_book',
    specialRequests: 'Single room supplement quote requested. Want private desert safari with dune buggy.',
    preferredContactMethod: 'whatsapp',
    status: 'Pending',
    depositPaid: 0,
    totalPrice: 380000,
    currency: 'JMD',
    budget: '$2,500 USD / person (Target Budget)',
    internalNotes: ['Customizing desert safari quote with private guide.'],
    createdAt: '2026-09-06T03:30:00Z',
...
export const INITIAL_ADMIN_ORDERS_EXCEL: AdminOrderExcelRecord[] = [
  {
    id: 'order-1',
    orderRef: 'ST-2026-8812',
    receivedAt: '2026-08-10T14:30:00.000Z',
    orderType: 'Booking Inquiry',
    customerName: 'Kadeen Campbell',
    email: 'kadeen.campbell@example.com',
    phone: '(876) 555-0192',
    parishOrCountry: 'St. Andrew, Jamaica',
    tripOrDestination: 'Panama 2026 — Part 2',
    travelDates: 'October 13–18, 2026',
    adultsCount: 2,
    childrenCount: 0,
    budget: '$1,000 USD / person (Package Rate)',
    totalPrice: 152303,
    depositPaid: 83353,
    currency: 'JMD',
    ...
    assignedAdmin: 'Elvoy Bennett',
    specialRequests: 'Celebrating anniversary. Would like adjacent rooms or double bed.',
    inclusions: 'Flights, Hotel B&B, 2 Excursions, Airport Transfers',
    adminNotes: 'Deposit confirmed via NCB direct transfer. Sent official booking confirmation packet.',
    lastUpdated: '2026-08-11T09:15:00.000Z',
  },
  {
    id: 'order-2',
    orderRef: 'ST-2027-4109',
    ...
    tripOrDestination: 'Germany + Italy Dual European Tour 2027',
    travelDates: 'February 3–10, 2027',
    adultsCount: 1,
    childrenCount: 0,
    budget: '$2,350 USD / person (approx.)',
    totalPrice: 358285,
    depositPaid: 0,
    currency: 'JMD',
    ...
    specialRequests: 'Need assistance with Schengen visa appointment dates and flight baggage allowance.',
    inclusions: 'European flights from KIN, High-Speed Train, Hotels, Tours',
    adminNotes: 'Emailed visa checklist and installment timeline on Aug 19. Awaiting deposit.',
    lastUpdated: '2026-08-19T16:00:00.000Z',
  },
  {
    id: 'order-3',
    orderRef: 'ST-2026-8842',
    ...
    phone: '(876) 848-9772',
    parishOrCountry: 'Kingston, Jamaica',
    tripOrDestination: 'Panama 2026 Experience',
    travelDates: 'October 13–18, 2026',
    adultsCount: 1,
    childrenCount: 0,
    budget: '$1,000 USD / person (Package Rate)',
    ...
    preferredContact: 'WhatsApp',
    assignedAdmin: 'Zachary Buchanan',
    specialRequests: 'Spot lock deposit verified for traveler group.',
    inclusions: 'Full group tour itinerary and document prep included.',
    adminNotes: 'Initial lock-in payment verified via Lynk / NCB receipt.',
    lastUpdated: '2026-09-06T04:45:00.000Z',
  },
  {
    id: 'order-4',
    orderRef: 'ST-2026-7731',
    receivedAt: '2026-09-06T03:30:00.000Z',
    orderType: 'Booking Inquiry',
    customerName: 'Kadeen Brown',
    email: 'kadeen.brown@example.com',
    phone: '(876) 555-8910',
    parishOrCountry: 'St. Catherine, Jamaica',
    tripOrDestination: 'Dubai Luxury Expedition 2026',
    travelDates: 'November 2026',
    adultsCount: 2,
    childrenCount: 0,
    budget: '$2,500 USD / person (Target)',
    totalPrice: 380000,
    depositPaid: 0,
    currency: 'JMD',
    paymentStatus: 'Unpaid',
    ...
    preferredContact: 'WhatsApp',
    assignedAdmin: 'Elvoy Bennett',
    specialRequests: 'Customer ready to lock in spot with deposit. Inquired about single occupancy upgrade option.',
    inclusions: 'Luxury 5-Star Hotel, Desert Safari, Yacht Dinner, Airport Transfers',
    adminNotes: 'Dispatched to Elvoy Bennett & Zachary Buchanan. Preparing payment breakdown for WhatsApp.',
    lastUpdated: '2026-09-06T03:30:00.000Z',
  },
  {
    id: 'order-5',
    orderRef: 'ST-CUSTOM-9104',
    receivedAt: '2026-09-08T12:00:00.000Z',
    orderType: 'Custom Trip',
    customerName: 'Marcus Sterling',
    email: 'msterling876@gmail.com',
    phone: '(876) 542-9911',
    parishOrCountry: 'Montego Bay, St. James',
    tripOrDestination: 'Tokyo & Kyoto, Japan',
    travelDates: 'April 4–14, 2027 (Cherry Blossom)',
    adultsCount: 4,
    childrenCount: 0,
    budget: '$3,500 USD / person ($14,000 Total Group)',
    totalPrice: 850000,
    depositPaid: 200000,
    currency: 'JMD',
    paymentStatus: 'Deposit Paid',
    orderStatus: 'Proposal Sent',
    preferredContact: 'WhatsApp',
    assignedAdmin: 'Zachary Buchanan',
    specialRequests: 'JR Shinkansen bullet train passes, authentic tea ceremony, anime & gaming tour.',
    inclusions: 'Tokyo hotel, Kyoto Ryokan with Onsen, Bullet Train, Private Tours',
    adminNotes: '10-day custom proposal delivered. Custom itinerary approved pending final flight tickets.',
