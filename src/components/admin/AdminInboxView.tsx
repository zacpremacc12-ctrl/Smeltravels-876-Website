  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-3xl p-6 border border-neutral-200 shadow-xs space-y-6">
        ...
        {/* Dual Admin Routing & Email Dispatch Status Pill */}
        <div className="p-3.5 rounded-2xl bg-gradient-to-r from-purple-900/10 via-amber-500/10 to-emerald-500/10 border border-purple-200 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs">
          <div className="flex items-center gap-2.5">
            <span className="w-2.5 h-2.5 rounded-full bg-emerald-500 animate-pulse shrink-0" />
            <span className="text-neutral-800 font-medium">
              <strong>Dual Admin Notification Active:</strong> Inquiries notify both <strong className="text-purple-900">Elvoy Bennett</strong> and <strong className="text-purple-900">Zachary Buchanan</strong> with automated email dispatches to <span className="font-mono text-[11px] text-purple-800 bg-purple-100/70 px-1.5 py-0.5 rounded">zbuchanan.smeltravels@gmail.com</span> & <span className="font-mono text-[11px] text-purple-800 bg-purple-100/70 px-1.5 py-0.5 rounded">smeltravels876@gmail.com</span>.
            </span>
          </div>
                ...
                <div className="space-y-1.5">
                  ...
                  {item.type === 'inquiry' && (
                    <div className="flex flex-wrap items-center gap-2 pt-1 text-[11px]">
                      <span className="inline-flex items-center gap-1 font-bold text-purple-900 bg-purple-100/70 border border-purple-200 px-2.5 py-0.5 rounded-lg">
                        <span>👥 Admins:</span>
                        <span>{item.adminRecipients?.join(' & ') || 'Elvoy Bennett & Zachary Buchanan'}</span>
                      </span>
                      <span className="inline-flex items-center gap-1 font-semibold text-emerald-800 bg-emerald-50 border border-emerald-200 px-2.5 py-0.5 rounded-lg">
                        <Mail className="w-3 h-3 text-emerald-600" />
                        <span>Email Sent: zbuchanan.smeltravels@gmail.com & smeltravels876@gmail.com</span>
                      </span>
                    </div>
                  )}
                </div>
              ...
              {selectedItemForModal.type === 'inquiry' && (
                <div className="p-3.5 bg-purple-50/80 border border-purple-200 rounded-2xl space-y-2">
                  ...
                  <p className="text-[11px] text-neutral-600">
                    This inquiry is logged in the admin inboxes of both <strong>Elvoy Bennett</strong> and <strong>Zachary Buchanan</strong>.
                  </p>
                  <div className="pt-1 border-t border-purple-200/60 text-[11px] text-purple-950 font-medium space-y-0.5">
                    <div className="flex items-center gap-1.5">
                      <Mail className="w-3.5 h-3.5 text-purple-700" />
                      <span>Automated email sent to: <strong>zbuchanan.smeltravels@gmail.com</strong></span>
                    </div>
                    <div className="flex items-center gap-1.5">
                      <Mail className="w-3.5 h-3.5 text-purple-700" />
                      <span>Automated email sent to: <strong>smeltravels876@gmail.com</strong></span>
                    </div>
                  </div>
                </div>
              )}
